  ...
  if (pending.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center text-center py-24 rounded bg-[#161616] border border-white/8">
        ...
        <h3 className="text-sm font-semibold">Queue is clear</h3>
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-3">
      {pending.map((l) => (
        <div
          key={l.id}
          className={`rounded bg-[#161616] border border-white/8 overflow-hidden hover:border-[#D4AF37]/30 transition-colors ${
