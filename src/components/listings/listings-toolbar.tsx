...
export function ListingSearchBar({ className }: { className?: string }) {
  ...
  return (
    <div className={className}>
      <div className="flex items-center gap-1.5 bg-white border border-[#E5E5E5] rounded-xl shadow-card p-1 pl-3">
        <Search className="h-3.5 w-3.5 text-[#C8A93E]" />
        <input
          type="text"
          value={value}
          ...
          className="flex-1 bg-transparent text-[#1A1A1A] placeholder:text-muted text-xs outline-none py-1.5"
        />
    ...
    <div className="flex items-center gap-1.5">
      <div className="relative">
        <select
          ...
          suppressHydrationWarning
          className="appearance-none flex items-center gap-1 h-7 pl-6 pr-6 rounded-sm bg-white border border-[#E5E5E5] text-[10px] text-secondary hover:border-[#C8A93E]/40 focus:outline-none cursor-pointer"
        >
