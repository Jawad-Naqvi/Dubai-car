  ...
  return (
    <div className="flex flex-col gap-3">
      <Link
        ...
        className="group flex items-center gap-3.5 rounded-2xl border border-[#E7E4DA] bg-white px-4 py-3.5 hover:border-[#141414]/30 hover:shadow-card transition-all"
      >
        <span className="h-10 w-10 rounded-xl bg-[#F3F1E9] flex items-center justify-center flex-shrink-0 group-hover:bg-[#141414] transition-colors">
