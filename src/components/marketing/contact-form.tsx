...
const inputCls =
  "h-11 w-full rounded-xl bg-white border border-[#E5E5EA] text-[#141414] placeholder:text-muted px-3 text-sm focus:outline-none focus:border-[#141414]/40 focus:ring-2 focus:ring-[#141414]/10";
...
export function ContactForm() {
  ...
  return (
    <div className="rounded-2xl bg-white border border-[#E5E5EA] shadow-card p-5 lg:p-6 relative overflow-hidden">
      ...
      <div className="relative">
        ...
        {done ? (
          <div className="mt-8 flex flex-col items-center text-center py-8">
            <CheckCircle2 className="h-10 w-10 text-[#8136B2]" />
          ...
          <form onSubmit={submit} className="mt-6 space-y-4">
            ...
            <textarea
              ...
              className="w-full rounded-xl bg-white border border-[#E5E5EA] text-[#141414] placeholder:text-muted px-3 py-2 text-sm focus:outline-none focus:border-[#141414]/40 focus:ring-2 focus:ring-[#141414]/10"
            />
            <Button
              type="submit"
              variant="gold"
